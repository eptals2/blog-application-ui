  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <main class="mx-auto max-w-4xl px-6 py-10">
      ...
      >
        ...
        <p
          v-if="error"
          class="mb-6 rounded-lg bg-red-50 p-3 text-sm text-red-600"
        >
          {{ error }}
        </p>
        ...
        <div class="flex items-center gap-3">
          ...
          <button
            type="submit"
            :disabled="loading"
            class="rounded-lg bg-blue-600 px-5 py-3 font-medium text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
